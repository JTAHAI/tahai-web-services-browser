...
export const PROFILE_COMMAND_REGISTRY: ProfileAwareCommand[] = [
  ...
  { id: 'reload', label: 'Reload Page', description: 'Reload the current page.', category: 'daily-browsing', targetScope: 'active-tab', requiredSurface: null, requiredToolGroup: null, isDestructive: false, shortcut: 'Ctrl+R / F5 / Ctrl+Shift+R' },
  ...
  { id: 'focus-address', label: 'Focus Address Bar', description: 'Focus the address bar.', category: 'daily-browsing', targetScope: 'active-tab', requiredSurface: null, requiredToolGroup: null, isDestructive: false, shortcut: 'Ctrl+L / Alt+D' },
