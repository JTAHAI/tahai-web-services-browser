...
Close the crash recovery + session durability gate for the TAHAI Web Services Browser enterprise reliability lane.
...
- `forcedKillRecoveryDocumented`
- `rendererCrashRecoveryDocumented`
- `failedWebviewRecoveryDocumented`
- `missionRestoreDocumented`
- `tabsRestoreDocumented`
- `layoutRestoreDocumented`
- `notesEvidencePreserved`
- `diagnosticShownInsteadOfSilentLoss`
...
This pass requires `PASS308` to remain PASS before its own gate can pass.
