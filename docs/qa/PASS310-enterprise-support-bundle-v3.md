...
Close the enterprise support bundle v3 gate for the TAHAI Web Services Browser enterprise reliability lane.
...
- `supportBundleContractExists`
- `redactionReportIncluded`
- `policyTruthIncluded`
- `installTruthIncluded`
- `runtimeDiagnosticsIncluded`
- `missionDiagnosticsIncluded`
- `recentErrorsAreNonSecret`
- `cookiesTokensStorageDumpsExcluded`
...
This pass requires `PASS309` to remain PASS before its own gate can pass.
