...
| Release phase | `enterprise-release-hardening` |
...
- `package.json` version matches `src/shared/release-truth.ts`.
- Main-process runtime config uses the shared release truth module.
- The About page and `browser/about/release-truth.json` report v1.8.30 / PASS141 / public-rc / manual-release.
