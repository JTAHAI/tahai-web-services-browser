...
Version remains `2.0.18`. Release channel remains `public-rc`. Update channel remains `manual-release`. The Windows build remains an unsigned preview until the approved signing lane is active.
...
4. **About/version truth** — About page shows v2.0.18/public-rc/manual-release/unsigned preview truth and does not claim GA.
