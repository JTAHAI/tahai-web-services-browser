...
// Optional, versioned trailer shared by session and recently-closed commands.
// Read accepts legacy commands ending before the trailer, but rejects malformed
// or unsupported trailers without partially changing the supplied visual data.
SESSIONS_EXPORT void WriteTahaiSplitGridExtension(
    base::Pickle* pickle,
    const split_tabs::SplitTabVisualData& visual_data);
SESSIONS_EXPORT bool ReadTahaiSplitGridExtension(
