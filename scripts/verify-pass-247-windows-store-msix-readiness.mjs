...
if (!msixPs1.includes('@microsoft/winappcli')) failures.push('packaging/windows/build-windows-msix.ps1: missing scoped @microsoft/winappcli npm fallback');
if (msixPs1.includes('npx winapp pack') || msixPs1.includes('\"winapp\", \"pack\"')) failures.push('packaging/windows/build-windows-msix.ps1: must not use bare npx winapp package lookup');
if (!msixPs1.includes('Get-Command winapp')) failures.push('packaging/windows/build-windows-msix.ps1: missing installed WinApp CLI PATH detection');
