...
// PASS88 release-blocker hardening: this verifier is often run after npm ci/build.
// Enforce source exclusion policy via .gitignore here; ZIP artifact contents are verified separately.
const gitignore = read('.gitignore');
for (const generated of ['dist/', 'release/', 'node_modules/', 'artifacts/']) {
  if (!gitignore.includes(generated)) failures.push(`generated output exclusion missing from .gitignore: ${generated}`);
}
