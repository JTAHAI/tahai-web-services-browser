...
includes('src/renderer/index.html',['Copy and save actions run through a second main-process redaction boundary','Redaction safety sanitizes URLs, titles, notes, pinned evidence bodies, and copy/save output before handoff','The same redaction gate protects privileged copy/save handoff paths']);
