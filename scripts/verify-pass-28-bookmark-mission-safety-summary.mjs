...
const required = [
  ...
  ['unsafe bookmark urls blocked before mission launch', (app.includes("if (!/^https?:\\/\\//i.test(normalized))") || app.includes('const candidate = pass90RecipeUrlCandidate(url);')) && app.includes('blockedCount += 1')],
