...
auto RunTahaiGuardEngine(
    mojo::PendingReceiver<tahai::guard::mojom::GuardEngine> receiver) {
  return std::make_unique<tahai::guard::GuardEngineImpl>(std::move(receiver));
}

auto RunTahaiSkinDecoder(
    mojo::PendingReceiver<tahai::skins::mojom::SkinDecoder> receiver) {
  return std::make_unique<tahai::skins::SkinDecoderImpl>(std::move(receiver));
}
...
void RegisterMainThreadServices(mojo::ServiceFactory& services) {
  ...
  services.Add(RunTahaiGuardEngine);
  services.Add(RunTahaiSkinDecoder);
