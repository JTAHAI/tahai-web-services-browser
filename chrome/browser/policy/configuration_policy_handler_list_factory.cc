...
const PolicyToPreferenceMapEntry kSimplePolicyMap[] = {
#if BUILDFLAG(IS_WIN)
  // TAHAI-owned profile policy. The existing Local OI service enforces these
  // effective preferences; a mandatory policy also locks the WebUI control.
  { key::kLocalOIEnabled, prefs::kTahaiLocalOiEnabled,
    base::Value::Type::BOOLEAN },
  { key::kTahaiNamedWorkspacesEnabled, prefs::kTahaiNamedWorkspacesEnabled,
    base::Value::Type::BOOLEAN },
  { key::kTahaiGuardConfiguration, prefs::kTahaiGuardConfiguration,
    base::Value::Type::DICT },
  { key::kTahaiGuardCustomRules, prefs::kTahaiGuardCustomRules,
    base::Value::Type::STRING },
  { key::kTahaiSkinsEnabled, prefs::kTahaiSkinsEnabled,
    base::Value::Type::BOOLEAN },
  ...
  { key::kLocalOIArtifactIngestionEnabled, prefs::kTahaiLocalOiArtifactIngestionEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIDocumentationReferenceIngestionEnabled, prefs::kTahaiLocalOiDocumentationReferenceIngestionEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIOpsToolIngestionEnabled, prefs::kTahaiLocalOiOpsToolIngestionEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIHistoryMetadataEnabled, prefs::kTahaiLocalOiHistoryMetadataEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIReportsEnabled, prefs::kTahaiLocalOiReportsEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIExportEnabled, prefs::kTahaiLocalOiExportEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOIMspPromotionEnabled, prefs::kTahaiLocalOiMspPromotionEnabled,
    base::Value::Type::BOOLEAN },
  { key::kLocalOILocalAIEnabled, prefs::kTahaiLocalOiLocalAiEnabled,
    base::Value::Type::BOOLEAN },
#endif
...
std::unique_ptr<ConfigurationPolicyHandlerList> BuildHandlerList(
  ...
  handlers->AddHandler(std::make_unique<IntRangePolicyHandler>(
      key::kLocalOIRetentionDays, prefs::kTahaiLocalOiRetentionDays, 1, 3650,
      /*clamp=*/false));
#endif
