...
// Returns true when this process has MSIX/AppX package identity. Packaged apps
// already receive an Application User Model ID from their manifest; replacing
// it with Chromium's desktop profile ID makes the Windows shell lose the
// package tile identity and fall back to an executable icon.
