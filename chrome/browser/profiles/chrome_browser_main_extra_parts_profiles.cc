...
#endif
#if BUILDFLAG(IS_WIN)
  tahai::guard::GuardProfileServiceFactory::GetInstance();
  tahai::skins::SkinProfileServiceFactory::GetInstance();
  tahai::MissionServiceFactory::GetInstance();
  tahai::TahaiLocalOiServiceFactory::GetInstance();
  tahai::ModeServiceFactory::GetInstance();
#endif
#if !BUILDFLAG(IS_ANDROID)
