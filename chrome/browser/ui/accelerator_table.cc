...
const AcceleratorMapping kAcceleratorMap[] = {
    ...
    {ui::VKEY_SPACE, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN, IDC_TAHAI_FINDER},
#endif
...
std::vector<AcceleratorMapping> GetAcceleratorList() {
  ...
  if (accelerators->empty()) {
    ...
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_Q, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_QUAD_VIEW}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_D, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_DUAL_VIEW}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_S, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_DUAL_VIEW_STACKED}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_G, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_TRI_VIEW_TWO_OVER_ONE}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_U, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_TRI_VIEW_ONE_OVER_TWO}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_F, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_QUAD_FOCUS}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_E, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_QUAD_EXIT}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_L, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_LAUNCHPAD}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_M, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_MISSION_CONTROL}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_O, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_COMMAND_CENTER}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_V, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_WORK_MODES}));
    accelerators->emplace_back(
        AcceleratorMapping({ui::VKEY_Y, ui::EF_SHIFT_DOWN | ui::EF_ALT_DOWN,
                            IDC_TAHAI_PROFILES}));
