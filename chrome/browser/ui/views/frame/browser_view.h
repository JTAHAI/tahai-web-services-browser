...
class BrowserView : public BrowserWindow,
 ...
 public:
  ...
  tahai::WindowModeController* tahai_window_mode_controller() const {
    return tahai_window_mode_controller_.get();
  }
  tahai::WorkspaceRailView* tahai_workspace_rail() const {
    return tahai_workspace_rail_;
  }
#endif
 ...
 private:
  ...
  // default so sibling windows can eventually use different work modes.
  std::unique_ptr<tahai::WindowModeController> tahai_window_mode_controller_;
  raw_ptr<tahai::WorkspaceRailView> tahai_workspace_rail_ = nullptr;
#endif
