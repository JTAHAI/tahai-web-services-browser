  ...
  if (const std::optional<split_tabs::SplitTabId> split = tab->GetSplit()) {
    ...
    if (tabs_in_split.size() > 2u) {
      title = l10n_util::GetStringFUTF16(
          label_id, title, base::NumberToString16(tab_index_in_split + 1),
