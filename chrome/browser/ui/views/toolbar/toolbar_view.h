...
#if BUILDFLAG(IS_WIN) && BUILDFLAG(TAHAI_BRANDING)
    ,
                    public tahai::WindowModeController::Observer
#endif
{
 ...
 public:
  ...
  ToolbarButton* tahai_mode_button() const { return tahai_mode_button_; }
  ToolbarButton* tahai_primary_button() const { return tahai_primary_button_; }
  ToolbarButton* tahai_secondary_button() const {
    return tahai_secondary_button_;
  }
  ToolbarButton* tahai_layout_button() const { return tahai_layout_button_; }
 ...
 private:
  ...
  void UpdateTahaiModeControls();
  void UpdateTahaiEnvironmentGuard(content::WebContents* tab);
#endif
  ...
  raw_ptr<ToolbarButton> tahai_mode_button_ = nullptr;
  raw_ptr<ToolbarButton> tahai_primary_button_ = nullptr;
  raw_ptr<ToolbarButton> tahai_secondary_button_ = nullptr;
  raw_ptr<ToolbarButton> tahai_layout_button_ = nullptr;
#if BUILDFLAG(IS_WIN) && BUILDFLAG(TAHAI_BRANDING)
  raw_ptr<ToolbarButton> tahai_environment_button_ = nullptr;
  raw_ptr<tahai::WindowModeController> tahai_window_mode_controller_ = nullptr;
  base::ScopedObservation<tahai::WindowModeController,
                          tahai::WindowModeController::Observer>
      tahai_window_mode_observation_{this};
#endif
