...
TEST_F(TabStripModelTest, TahaiQuadUsesFourNativeTabs) {
  ASSERT_NO_FATAL_FAILURE(
...
TEST_F(TabStripModelTest, ClosingTahaiQuadPanePreservesThreePaneSplit) {
  ASSERT_NO_FATAL_FAILURE(
...
TEST_F(TabStripModelTest, RestoreTahaiQuadPreservesMemberOrder) {
  ASSERT_NO_FATAL_FAILURE(
