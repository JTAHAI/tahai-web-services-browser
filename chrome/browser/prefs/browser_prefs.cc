...
void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry,
  ...
  registry->RegisterDictionaryPref(prefs::kTahaiGuardConfiguration);
  registry->RegisterStringPref(prefs::kTahaiGuardCustomRules, "");
  registry->RegisterDictionaryPref(prefs::kTahaiSkinSelection);
  ...
  // default; an operator or managed deployment must opt in explicitly.
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiMspPromotionEnabled, false);
  registry->RegisterDictionaryPref(prefs::kTahaiLocalOiStore);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiEnabled, true);
  registry->RegisterIntegerPref(prefs::kTahaiLocalOiRetentionDays, 90);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiMissionIngestionEnabled,
                                true);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiArtifactIngestionEnabled,
                                true);
  registry->RegisterBooleanPref(
      prefs::kTahaiLocalOiDocumentationReferenceIngestionEnabled, true);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiOpsToolIngestionEnabled,
                                true);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiHistoryMetadataEnabled,
                                false);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiReportsEnabled, true);
  registry->RegisterBooleanPref(prefs::kTahaiLocalOiExportEnabled, true);
