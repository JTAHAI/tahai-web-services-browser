...
TEST_F(SessionServiceTest, SplitTabDataSaved) {
  ...
  std::array<split_tabs::SplitTabVisualData, kNumSplitTabs> visual_data = {
      split_tabs::SplitTabVisualData(split_tabs::SplitTabLayout::kStacked, 0.2),
      split_tabs::SplitTabVisualData(split_tabs::SplitTabLayout::kSideBySide,
                                     0.7)};
  visual_data[0].set_tahai_grid_ratios(0.3, 0.7);
  visual_data[1].set_tahai_grid_ratios(0.6, 0.4);
