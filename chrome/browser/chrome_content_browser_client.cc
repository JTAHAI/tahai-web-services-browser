...
bool HandleTahaiNewTabURL(GURL* url, content::BrowserContext* browser_context) {
...
bool HandleTahaiPublicURL(GURL* url, content::BrowserContext* browser_context) {
...
#if BUILDFLAG(IS_WIN)
  tahai::guard::GuardURLLoaderFactory::MaybeProxy(
      browser_context, type, request_initiator, isolation_info, factory_builder,
      frame, ukm_source_id);
#endif
