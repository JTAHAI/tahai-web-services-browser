...
(() => {
  'use strict';
  const scriptURL = document.currentScript?.src || new URL('./start-20260913-royal.js', location.href).href;
  ...
  const routes = [
    ...
    { title: 'Skins and creator resources', detail: 'Appearance, offline creator kit and starter skin', badge: 'Create', url: local('/skins/') },
